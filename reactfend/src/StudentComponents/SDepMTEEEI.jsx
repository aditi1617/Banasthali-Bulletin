	...
	return(
		<>
		  ...
		  <div className="events-posts">
		    <EventsS category="mtdepartments" refreshto="sdepartments"/>
		    <PostsS category="mtdepartments" refreshto="sdepartments"/>
