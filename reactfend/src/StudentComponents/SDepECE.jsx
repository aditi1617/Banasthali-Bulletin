	...
	return(
		<>
		  ...
		  <div className="events-posts">
		    <EventsS category="ecedepartments" refreshto="sdepartments"/>
		    <PostsS category="ecedepartments" refreshto="sdepartments"/>
